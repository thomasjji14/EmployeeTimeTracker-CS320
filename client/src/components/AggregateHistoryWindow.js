...
const AggregateHistoryWindow = ({ isListPresent, setListPresence, employeeData }) => {
  ...
  //   updateGraphLoad(0)
  //   const result = await requests.getAllTime(employeeData.employeeId, employeeData.companyId)
